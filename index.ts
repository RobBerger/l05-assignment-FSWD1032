class Employee {
    ...
    printDetails(): string {
        return `${this.name} is a ${this.title} in the ${this.department} department with a salary of $${this.salary}.`;
    }
}
...
let tammy: Manager = new Manager('Tammy', 'Director', 'Aquatics', 50000, 7, 2000);
